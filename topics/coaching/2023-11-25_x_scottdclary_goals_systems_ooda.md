---
title: "Goals vs systems: SMART + HABIT + OODA (Scott D. Clary)"
date: 2023-11-25
type: note
topics:
  - coaching
...
Goals define **direction + what to say no to**; systems create the **daily actions** that make progress inevitable. Use:
- **SMART** to write goals well
- **HABIT** to design the system
- **OODA** as the feedback loop to adjust both
...
## Coaching lens (how I’d apply this)

### 1) Goals = vision + filtration

- Good goals help you decide what *not* to do.
- If you can’t use the goal to say “no” to something, it’s not filtering.

### 2) Systems = habits + action

- A system is a repeatable set of behaviors that makes the goal more likely.
- The system should be **actionable** at the level of “what do I do today?”

### 3) OODA = learning loop

Treat your goal+system as a hypothesis:
- **Observe**: What happened this week?
- **Orient**: What does it mean? Where’s the gap?
- **Decide**: What’s the smallest adjustment?
- **Act**: Run it and re-observe.

## Figures

Embedded from the thread:

![figure](https://pbs.twimg.com/media/F_yeeKAWkAA70Kt?format=jpg&name=medium)

![figure](https://pbs.twimg.com/media/F_yfCJNXUAAXmD5?format=jpg&name=medium)

![figure](https://pbs.twimg.com/media/F_zA04MXAAAdArz?format=jpg&name=medium)

Local copies (repo): `topics/coaching/assets/scottdclary_goals_systems/`

...
title: "Raw: MCP vs CLI/tools (Lance Martin + Armin Ronacher)"
author: "(multiple)"
created_at: 2026-02-19
extracted_at: 2026-02-19
extractor: "fxtwitter + readability"
topics:
  - agents
tags:
  - mcp
...
Media:
- https://x.com/RLanceMartin/status/2023824176029761931/photo/1

## Source 2 — Article (Armin Ronacher)
...
- I asked the LLM to perform the core transformation from reStructuredText to
...
- Then, I asked it to write a script that compares the old HTML with the new HTML,
...
- After that was done, I asked it to create a third script, which I could run
